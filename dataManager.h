...
public:
    ...
    void                      saveCustomers(const std::string& filename,
                                            std::vector<customer>& customers);

    // ── quotes ────────────────────────────────────
    std::vector<quote>        loadQuotes(const std::string& filename);
    void                      saveQuotes(const std::string& filename,
                                         std::vector<quote>& quotes);

    // ── invoices ──────────────────────────────────
    std::vector<invoices>     loadInvoices(const std::string& filename);
    void                      saveInvoices(const std::string& filename,
    ...
    void                      saveAppointments(const std::string& filename,
